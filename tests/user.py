...
def test_create_invalid_user(user_service):
...
# TODO: add more cases
def test_update_invalid_user(user_service):
    user_service.create_user(user_service.user_json)
...
# TODO: add more cases
def test_update_absent_user(user_service):
...
# TODO: add more cases
def test_get_user_invalid_username(user_service):
...
# return 200 instead of 404
# TODO: add more cases
def test_get_absent_user(user_service):
...
def test_get_deleted_user(user_service):
    user_service.create_user(user_service.user_json)
...
@pytest.mark.xfail
# returns 200 instead of 404
def test_deleted_user(user_service):
    user_service.create_user(user_service.user_json)
    user_service.delete_user(user_service.user.username)
    response = user_service.delete_user(user_service.user.username)
    assert 404 == response.status_code
